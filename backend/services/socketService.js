...
// Map to track typing status -> userId -> [conversations]: boolean
    ...
    io.on("connection", (socket) => {
        ...
        socket.on("user_connected", async (connectingUserId) => {
            try {
                ...
                console.log("Error handing user connection", error);
            }
        });
        ...
        //handle tying start event and auto-stop
