        ...
        >
            ...
            >
                <motion.div
                    ...
                    className="flex items-center justify-center w-24 h-24 mx-auto mb-6 bg-green-500 rounded-full"
                >
                ...
                {step === 1 && (
                    <form action="" className="space-y-4" onSubmit={handleLoginSubmit(onLoginSubmit)}>
                        <p className={`text-center ${theme === "dark" ? "text-gray-300" : "text-gray-600"} mt-4`}>
                            Enter your phone number to receiver an OTP
                        </p>
                ...
                {step === 2 && (
                    <form action="" onSubmit={handleOtpSubmit(onOtpSubmit)} className="space-y-4">
                        ...
                        <form onSubmit={handleProfileSubmit(onProfileSubmit)} className="space-y-4">
                            <div className="flex flex-col items-center mb-4">
                                <div className="relative w-24 h-24 mb-2">
                                    ...
                                    <label
                                        ...
                                        className="absolute bottom-0 right-0 p-2 text-white transition duration-300 bg-green-500 rounded-full cursor-pointer hover:bg-green-600"
                                    >
                            ...
                            <div className="flex items-center space-x-2">
                                <input
                                    ...
                                    type="checkbox"
                                    className={`rounded ${
                                        theme === "dark" ? "text-green-500 bg-gray-700" : "text-green-500"
                                ...
                                {profileErrors.agreed && (
                                    <p className="mt-1 text-sm text-red-500">{profileErrors.agreed.message}</p>
                                )}
                            </div>
                            <button
