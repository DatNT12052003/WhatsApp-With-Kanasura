        ...
        <Layout isThemeDialogOpen={isThemeDialogOpen} toggleThemeDialog={toggleThemeDialog}>
            <div
                className={`flex h-screen ${
                    theme === "dark" ? "bg-[rgb(12,27,33)] text-white" : "bg-white text-black"
                }`}
            >
                            ...
                            <div className="space-y-1">
                                {[
                                    ...
                                    <Link
                                        to={item.href}
                                        key={item.label}
                                        className={`w0full flex items-center gap-2 p-2 rounded ${
                                            theme === "dark"
                                ...
                                >
                                    {theme === "dark" ? <FaMoon className="h-5 2-5" /> : <FaSun className="h-5 2-5" />}
                                    <div
