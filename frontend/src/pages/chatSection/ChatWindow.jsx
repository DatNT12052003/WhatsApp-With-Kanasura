...
const ChatWindow = ({ selectedContact, setSelectedContact, isMobile }) => {
    ...
    if (!selectedContact) {
        return (
            <div className="flex flex-col items-center justify-center flex-1 h-screen mx-auto text-center">
    ...
    return (
        <>
            <div className="flex flex-col flex-1 w-full h-screen">
                <div
                    className={`p-4 ${
                        theme === "dark" ? "bg-[#303430] text-white" : "bg-[rgb(239,242,245)] text-gray-600"
                    } flex items-center`}
                >
                    ...
                    <div className="flex items-center space-x-4">
                        <button className="focus:outline-none">
                            <FaVideo
                                className="w-5 h-5 text-green-500 hover:text-green-600"
                    ...
                    <div className="relative p-2">
                        {selectedFile?.type.startsWith("video/") ? (
                            <video
                                src={filePreview}
                                controls
                                className="object-cover mx-auto rounded shadow-lg max-h-[450px]"
                        ...
                        <button
                            ...
                            className="absolute p-1 text-white bg-red-500 rounded top-1 right-1 hover:bg-red-600"
                        >
                ...
                >
                    ...
                    {showEmojiPicker && (
                        <div ref={emojiPickerRef} className="absolute left-0 z-50 bottom-16">
                            <EmojiPicker
