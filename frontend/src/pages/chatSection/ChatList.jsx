    ...
    return (
        ...
        >
            <div className={`p-4 flex justify-between ${theme === "dark" ? "text-white" : "text-gray-800"}`}>
                ...
                <button className="p-2 text-white transition-colors bg-green-500 rounded-full hover:bg-green-600">
                    <FaPlus />
                </button>
            </div>
            <div className="p-2">
                <div className="relative">
                    ...
                    <input
                        ...
                        className={`w-full pl-10 pr-4 py-2 border rounded-lg focus:outline-none focus:ring-green-500 focus:ring-2 ${
                            theme === "dark"
