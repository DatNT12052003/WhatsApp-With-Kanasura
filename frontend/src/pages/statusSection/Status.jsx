        ...
        >
            <motion.div
                ...
                className={`flex-1 h-screen border-r ${
                    theme === "dark" ? "bg-[rgb(12,29,24)] text-white border-gray-600" : "bg-gray-100 text-black"
                }`}
            >
                <div
                ...
                {error && (
                    <div className="px-4 py-3 mx-4 mt-2 text-red-700 bg-red-100 border border-red-400 rounded">
                        ...
                        >
                            ...
                            {userStatuses ? (
                                <>
                                    ...
                                    <button
                                        className="absolute bottom-0 right-0 p-1 text-white bg-green-500 rounded-full"
                                        onClick={(e) => {
                                            e.stopPropagation();
                    ...
                    {showOption && userStatuses && (
                        <div className={`shadow-md p-2 ${theme === "dark" ? "bg-[rgb(17,27,33)] " : "bg-white"}`}>
                            <button
                                ...
                                className="flex items-center w-full px-2 py-2 text-left text-green-500 rounded hover:bg-gray-100"
                            >
                            ...
                            <button
                                ...
                                className="w-full px-2 py-2 text-left text-blue-500 rounded hover:bg-gray-100"
                            >
                                View Status
                            </button>
                        </div>
                                ...
                                <div className="mb-4">
                                    {selectedFile?.type.startsWith("video/") ? (
                                        <video
                                            src={filePreview}
                                            controls
                                            className="object-cover rounded max-h-[450px] w-full h-32"
                                            // className="object-cover mx-auto rounded shadow-lg w-80"
                                        ></video>
                                    ) : (
                                        <img
                                            src={filePreview}
