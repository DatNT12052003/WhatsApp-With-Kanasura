        ...
        >
            ...
            {isThemeDialogOpen && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
                    ...
                    >
                        <h2 className="mb-4 text-2xl font-semibold">Choose a theme</h2>
                        <div className="space-y-4 ">
                            <label className="flex items-center cursor-pointer space-x-x3">
                                <input
                                    type="radio"
                                    value="light"
                                    checked={theme === "light"}
                                    onChange={() => setTheme("light")}
                                    className="text-blue-600 from-radio"
                                />
                                <span>Light</span>
                            </label>
                            <label className="flex items-center cursor-pointer space-x-x3">
                        ...
                        <button
                            ...
                            className="w-full py-2 mt-6 text-white transition duration-200 bg-blue-500 rounded hover:bg-blue-600"
                        >
                            Close
                        </button>
                    </div>
